...
describe("test case for getting node data in concated string format",function(){
    let listObj1=new linkedlist.LinkList();
    let tc1=listObj1.getString();
    it("you should not concat node data from empty linked list",function(){
        assert.equal(tc1,"you should not concat node data from empty linked list");
    });
