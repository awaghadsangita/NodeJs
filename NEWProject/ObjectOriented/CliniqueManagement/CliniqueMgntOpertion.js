...
class CliniqueOperation {
    ...
    addNewPatient(name, mobilenumber, age) {
        try {
            ...
            this.patientArray.push(patientObj);
            this.writeJsonArrayToFile(patientFileName, this.patientArray);
            return patientid;
        } catch (e) {
            return e;
        }
    ...
    addAppointment(patientid, doctorarrayindex, date) {
        try {
            ...
            this.appointmentArray.push(appointmentObj);
            this.writeJsonArrayToFile(appointmentFileName, this.appointmentArray);
            return true;
        } catch (e) {
            console.log(e)
            return e;
